...
import { IconUser, IconSettings, IconLogout, IconDashboard, IconUsers, IconBox, IconWallet, IconShoppingBag, IconBook, IconMenu, IconAddressBook, IconMail, IconLibrary } from '../../admin/components/icons';
